...
**Last updated:** 2026-09-17 (`20_4` Gx.9 green, merged to `20_port` `18ee0d5a1d0`. Next: `20_12`.)
...
| 5 — per-group loops on saas-19.4 | **in progress** — `20_2` / `20_c` / `20_14` / `20_5` / `20_6` / `20_9` / `20_10` / `20_4` **Gx.9 green**. Next `20_12`. Shared `tools` / `enterprise` stay `19.0`. |
